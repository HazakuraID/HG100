...
public class MainActivity extends Activity {
  @Override public void onCreate(Bundle b) {
    super.onCreate(b);
    if (Build.VERSION.SDK_INT >= 30) getWindow().setFrameRate(120.0f);
    TextView v = new TextView(this);
    v.setText("Game Helio G100\n\nAndroid 16 / API 36\n120 FPS frame-rate request\nMali-G57 MP2\n\nProfiles:\nQQ飞车: com.tencent.tmgp.speedmobile\nSpeed Drifters: com.garena.game.fctw\n\n120 FPS depends on display, Android and game support.\nNo game injection, driver bypass, anti-cheat bypass, root, or Play Protect bypass.");
